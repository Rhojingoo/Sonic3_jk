...
namespace jk
{
	...
	void PlayScene4::Initialize()
	{
		...
		//mSonic->GetComponent<Transform>()->SetPos(Vector2{ 840.f, 5085.f });
		...
		tails->GetComponent<Transform>()->SetPos(Vector2{ 840.f, 5085.f });
	...
	//배경
		...
		sky1->GetComponent<Transform>()->SetPos(Vector2{ 100.f, 0.f });//432
