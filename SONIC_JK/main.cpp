// API_JK.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
#include <crtdbg.h>
#define DEBUG_NEW new(_NORMAL_BLOCK, THIS_FILE, __LINE__ )  // 누수 오류 남는거 확인
...
// _CrtSetBreakAlloc(17115);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SONICJK));
