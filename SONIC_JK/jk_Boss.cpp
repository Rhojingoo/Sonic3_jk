			...
			if (sonicState == Sonic::eSonicState::Dash || sonicState == jk::Sonic::eSonicState::Jump || sonicState == jk::Sonic::eSonicState::Spin)
			{
				...
				case jk::Boss::eBossState::Down_Dianogol:
				{
					if (mDir == -1)
					{
						...
						hurt_state = 1;
						mAnimator->GetCompleteEvent(L"L_Boss_dianogol_hurt") = std::bind(&Boss::hurt_dianogol, this);
					} 
					if (mDir == 1)
					{
				...
				case jk::Boss::eBossState::Attack_Dianogol_Waiting:
				{
					if (mDir == -1)
					{
						mAnimator->Play(L"L_Boss_dianogol_hurt", false);
					...
					else
					{
						mAnimator->Play(L"R_Boss_dianogol_hurt", false);
						hurt_state = 2;
						mAnimator->GetCompleteEvent(L"R_Boss_dianogol_hurt") = std::bind(&Boss::hurt_dianogol, this);
					}
					break;
				}
				case jk::Boss::eBossState::Side_Dianogol:
				{
					if (mDir == -1)
					{
						mAnimator->Play(L"L_Boss_dianogol_hurt", false);
				...
				case jk::Boss::eBossState::Dianogol_Side:
				{
					if (mDir == -1)
					{
						mAnimator->Play(L"L_Boss_dianogol_hurt", false);
						hurt_state = 7;
						mAnimator->GetCompleteEvent(L"L_Boss_dianogol_hurt") = std::bind(&Boss::hurt_side, this);
					}
					else
					{
						mAnimator->Play(L"R_Boss_dianogol_hurt", false);
						hurt_state = 7;
						mAnimator->GetCompleteEvent(L"R_Boss_dianogol_hurt") = std::bind(&Boss::hurt_side, this);
					}
					break;
				}

				case jk::Boss::eBossState::Side_Down:
				{
					if (mDir == -1)
					{
				...
				case jk::Boss::eBossState::Attack_Side_Waiting:
				{
					if (mDir == -1)
					{
						mAnimator->Play(L"L_Boss_side_hurt", false);
						hurt_state = 9;
						mAnimator->GetCompleteEvent(L"L_Boss_side_hurt") = std::bind(&Boss::hurt_side, this);
					}
					else
					{
						mAnimator->Play(L"R_Boss_side_hurt", false);
						hurt_state = 9;
						mAnimator->GetCompleteEvent(L"R_Boss_side_hurt") = std::bind(&Boss::hurt_side, this);
					}
					break;
				}
